...
class ControllerBackend extends Controller
{
    public function ShowLoginTopMenu(){
        ...
        $user = User::select('*')->leftjoin('permission','permission.id_user','users.id')
                                 ->leftjoin('wilayah','wilayah.id_wilayah','permission.id_wilayah')
    ...
    public function ShowProfil(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        return view('html.profil',compact('datauserid'));
    }
    ...
    public function ShowUser(){
        ...
        $datawilayah = wilayah::orderby('id_wilayah','DESC')->get();
        $datarole = role::orderby('id_role','ASC')->get();
        return view('html.user',compact('datauser','datawilayah','datarole','dataterminal','datauserid'));
    }
    ...
    public function ShowRegisterUser(Request $request){
        ...
        $savepermission->id_terminal    = $request->id_terminal;
        $savepermission->save();
    ...
    public function ShowWilayah(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $datawilayah = wilayah::select('*')
        ->join('bptb','bptb.id_bptb','=','wilayah.induk_wilayah')
        ->orderby('id_wilayah','DESC')
        ->get();
        $databptd = bptb::orderby('id_bptb','DESC')->get();
        return view('html.wilayah',compact('datawilayah','databptd','datauserid'));
    }
    ...
    public function ShowSimpanWilayah(Request $request){
        ...
        $savewilayah->kode_wilayah      = $request->kode_wilayah;
    ...
    public function ShowUpdateWilayah($id){
        $upgetdata = wilayah::where('id_wilayah',$id)->first();
        return response()->json([
                'success' => true,
                'message' => 'Update data',
                'data'    => $upgetdata  
    ...
    public function ShowUpdatePostWilayah(Request $request){
        ...
        $savewilayah = wilayah::where('id_wilayah',$request->id)->first();
        $savewilayah->kode_wilayah      = $request->kode_wilayah;
        $savewilayah->nama_wilayah      = $request->nama_wilayah;
        $savewilayah->induk_wilayah     = $request->induk_wilayah;
        $savewilayah->level             = $request->level;
    ...
    public function ShowDeleteWilayah(Request $request){
        $data = wilayah::where('id_wilayah',$request->id)->delete();
    ...
    public function ShowRole(){
        ...
        return view('html.role',compact('data','datauserid'));
    }
    ...
    public function ShowTerminal(){
        ...
        $datakota = kota::orderby('id_kota','DESC')->get();
        $datasdm = sdm::orderby('id','DESC')->get();
        return view('html.terminal',compact('dataterminal','databptd','datakota','datatryek','datasdm','datauserid'));
    }
    ...
    public function ShowEditTerminal($id){
        $dataterminal = terminal::select('*')
            ...
            ->first();
        $datatryek = trayek::orderby('id_trayek','DESC')->where('id_terminal',$id)->get();
        $databptd = bptb::orderby('id_bptb','DESC')->get();
        $datakota = kota::orderby('id_kota','DESC')->get();

        $datasdm = sdm::orderby('id','DESC')->where('id_terminal',$id)->get();
        $datakota = kota::orderby('id_kota','DESC')->get();
        ...
        $datakota = kota::orderby('id_kota','DESC')->get();
        $datapo   = perusahaan_otobus::orderby('id_perusahaan_otobus','DESC')->where('id_terminal',$id)->get();
    ...
    public function ShowSimpanSDMTerminal(Request $request){
        ...
        $simpansdm->id_terminal = $request->id_terminal;
    ...
    public function ShowSimpanPOTerminal(Request $request){
        ...
        $datapo->id_terminal    = $request->id_terminal;
    ...
    public function ShowSDM(){
        ...
        ->where('permission.id_user',Auth::user()->id)
        ->first();
        $datasdm = sdm::select('sdm.*','terminal.*','sdm.no_telp as nomor')->leftjoin('terminal','terminal.id_terminal','sdm.id_terminal')->orderby('id','DESC')->get();
        $dataterminal = terminal::all();
        return view('html.sdm',compact('datasdm','datakota','datawilayah','dataterminal','datauserid'));
    }
    ...
    public function ShowUpdateSDM($id){
        $upgetdata = sdm::select('terminal.*','sdm.*','sdm.tipe as tipes')->leftjoin('terminal','terminal.id_terminal','sdm.id_terminal')->orderby('id','DESC')
                ->where('id',$id)
                ->first();
        $datawilayah = permission::select('*')
        ->leftjoin('wilayah','wilayah.id_wilayah','=','permission.id_wilayah')
    ...
    public function ShowPO(){
        ...
        return view('html.po',compact('datapo','datakota','datauserid'));
    }
    ...
    public function ShowEditPO($id){
            ...
            $datakendaraan = kendaraan::select('trayek.*', 'prs.*', 'kendaraan.*','kendaraan.id_kendaraan as idks')
                        ...
                        ->get();
            return view('html.edit_po',compact('datapo','datakota','dataperusahaanotobus','datakendaraan','datatryek','datauserid'));
    }
    ...
    public function ShowUpdateDataPO($id){
        $upgetdata = perusahaan_otobus::select('*')
            ->join('kota','kota.id_kota','=','perusahaan_otobus.id_kota')
            ->orderby('id_perusahaan_otobus','DESC')
    ...
    public function ShowTrayek(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $datatryek = trayek::orderby('id_trayek','DESC')->get();
        return view('html.trayek',compact('datatryek','datauserid'));
    }
    ...
    public function ShowEditTrayek($id){
        ...
        return view('html.edit_trayek',compact('datatryek','dataterminal','masterterminaltrayek','mastertrayekkendaraan','masterterminalangkutantrayek','datauserid'));
    }
    ...
    public function ShowKendaraan(){
        ...
        return view('html.kendaraan',compact('datakendaraan','dataperusahaanotobus','datatrayek','datauserid'));
    }
    ...
    public function ShowDataKendaraanTiba(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $iduser = Auth::user()->id;
        $kendaraan_tiba = kendaraan_tiba::select('sdm.*','kendaraan.*','kendaraan_tiba.*','perusahaan_otobus.*','kendaraan_tiba.no_kendaraan as noken')
        ...
        return view('html.kendaraan_tiba',compact('kendaraan_tiba','dataterminal','dataterminalget','kendaraan','datauserid'));
    }

    public function ShowDataKendaraanKeluar(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $kendaraan_keluar = kendaraan_keluar::select('sdm.*','kendaraan.*','kendaraan_keluar.*','perusahaan_otobus.*','kendaraan_keluar.no_kendaraan as noken')
        ...
        $dataterminal = terminal::all();
        $kendaraan = kendaraan::all();
        return view('html.kendaraan_keluar',compact('kendaraan_keluar','dataterminal','dataterminalget','kendaraan','datauserid'));
    }
    ...
    public function ShowPenumpangTiba(){
         $datauserid = ControllerBackend::ShowLoginTopMenu();
         $kendaraan_tiba = kendaraan_tiba::select('terminal.*','sdm.*','kendaraan.*','kendaraan_tiba.*','perusahaan_otobus.*','kendaraan_tiba.no_kendaraan as noken')
                        ->leftjoin('sdm','sdm.nip','kendaraan_tiba.nip')
                        ->leftjoin('kendaraan','kendaraan.no_kendaraan','kendaraan_tiba.no_kendaraan')
                        ->leftjoin('perusahaan_otobus','perusahaan_otobus.kode_po','kendaraan.id_perusahaan_otobus')
        ...
        $dataterminal = terminal::all();
        $kendaraan = kendaraan::all();
        return view('html.penumpang_tiba',compact('kendaraan_tiba','dataterminal','dataterminalget','kendaraan','datauserid'));
    }
    ...
    public function ShowPenumpangTurun(){
        ...
        $dataterminal = terminal::all();
        $kendaraan = kendaraan::all();
        return view('html.penumpang_turun',compact('kendaraan_tiba','dataterminal','dataterminalget','kendaraan','datauserid'));
    }
    ...
    public function ShowPenumpangNaik(){
        ...
        $dataterminal = terminal::all();
        $kendaraan = kendaraan::all();
        return view('html.penumpang_naik',compact('kendaraan_tiba','dataterminal','dataterminalget','kendaraan','datauserid'));
    }
    ...
    public function ShowPenumpangBerangkat(){
        ...
        $dataterminal = terminal::all();
        $kendaraan = kendaraan::all();
        return view('html.penumpang_berangkat',compact('kendaraan_tiba','dataterminal','dataterminalget','kendaraan','datauserid'));
    }
    ...
    public function ShowSpionamKendaraan(){
        ...
        $dataspionamkendaraan = spionam_kendaraan::orderby('id','DESC')->get();
                       // ->orderby('kendaraan_tiba.id','DESC')
        return view('html.spionam_kendaraan',compact('dataspionamkendaraan','datauserid'));
    }
    public function ShowSpionamPerusahaan(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $dataspionamperusahaan = spionam_perusahaan::orderby('id','DESC')->get();
        return view('html.spionam_perusahaan',compact('dataspionamperusahaan','datauserid'));
    }
    public function ShowEblue(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
         $dataeblue = eblue::orderby('id','DESC')->get();
        return view('html.eblue',compact('dataeblue','datauserid'));
    }
    public function ShowDipass(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $datadipass = dipass::orderby('id','DESC')->get();
        return view('html.dipass',compact('datadipass','datauserid'));
    }

    public function ShowReportTerminalKendaraan(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $datapenumpang = kendaraan_tiba::select('*')->leftjoin('terminal','kendaraan_tiba.terminal_tujuan','terminal.id_terminal')->get();

        return view('html.report_terminal_kendaraan',compact('datauserid','datapenumpang'));
    }

    public function ShowReportTerminalPenumpang(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        return view('html.report_terminal_penumpang',compact('datauserid'));
    }
    ...
    public function ShowUpdateChecker(Request $request){
        ...
        if($request->penumpang== "penumpang_tiba"){
            $upkend->jumlah_penumpang_tiba = $request->jumlah_penumpang;
             $upkend->terminal_tujuan = $request->terminal_tujuan;
            $notif = "Jumlah penumpang naik berhasil diupdate";
        } else {
            $upkend->jumlah_penumpang_turun = $request->jumlah_penumpang;
            $upkend->terminal_tujuan = $request->terminal_tujuan;
            $notif = "Jumlah penumpang turun berhasil diupdate";
        }
        $upkend->update();
        return redirect()->back()->with('notif',$notif);
    }

    // menu rancang bangunan
    public function ShowRancangTerminal()
    {
        $dataterminal = terminal::all();
        // $datarancang_terminal = rancang_terminal::all();
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $datarancang_terminal = rancang_terminal::select('*')->leftjoin('terminal', 'terminal.id_terminal', 'rancang_terminal.nama_terminal')->orderby('id_rancang_terminal', 'DESC')->get();
        return view('html.rancangterminal', compact('datarancang_terminal', 'dataterminal','datauserid'));
    }


    public function ShowSimpanRancangTerminal(Request $request)
    {
        // penamaan file dan file path upload rancang bangunan
        ...
        $simpanrancang_terminal->nama_terminal    = $request->nama_terminal;
    ...
    {
        if ($request->file('sk_penetapan_lokasi') == "") {
            $filesk_penetapan_lokasi = "-";
        } else {
            $file = $request->file('sk_penetapan_lokasi');
            $extfile = $file->getClientOriginalExtension();
            $filesk_penetapan_lokasi = rand(100000, 1001238912) . "." . $extfile;
            $file->move('upload/sk_penetapan_lokasi', $filesk_penetapan_lokasi);
            $path_sk_penetapan_lokasi = 'SK Penetapan Lokasi - ' . $filesk_penetapan_lokasi;
        }
        if ($request->jumlah_peringatan == "") {
            $warget = "0";
        } else {
        ...
        if ($request->file('ba_serah_terima') == "") {
            ...
            $fileba_serah_terima = rand(100000, 1001238912) . "." . $extfile;
            $file->move('upload/ba_serah_terima', $fileba_serah_terima);
            $path_ba_serah_terima = '' . $fileba_serah_terima;
        }
        if ($request->jumlah_peringatan == "") {
            $warget = "0";
        } else {
        ...
        if ($request->file('sertifikat') == "") {
            ...
            $filesertifikat = rand(100000, 1001238912) . "." . $extfile;
            $file->move('upload/sertifikat', $filesertifikat);
            $path_sertifikat = '' . $filesertifikat;
        }
        if ($request->jumlah_peringatan == "") {
            $warget = "0";
        } else {
        ...
        if ($request->file('feasibility_study') == "") {
            $filefeasibilitystudy = "-";
        } else {
            $file = $request->file('feasibility_study');
            $extfile = $file->getClientOriginalExtension();
            $filefeasibilitystudy = rand(100000, 1001238912) . "." . $extfile;
            $file->move('upload/feasibility_study', $filefeasibilitystudy);
            $path_feasibilitystudy = '' . $filefeasibilitystudy;
        }
        if ($request->jumlah_peringatan == "") {
            $warget = "0";
        } else {
        ...
        if ($request->file('master_plan') == "") {
            ...
            $file = $request->file('master_plan');
            $extfile = $file->getClientOriginalExtension();
            $filemasterplan = rand(100000, 1001238912) . "." . $extfile;
            $file->move('upload/master_plan', $filemasterplan);
            $path_masterplan = '' . $filemasterplan;
        }
        if ($request->jumlah_peringatan == "") {
            $warget = "0";
        } else {
        ...
        $simpanrancang_terminal = new rancang_terminal();
        $simpanrancang_terminal->nama_terminal = $request->nama_terminal;
        $simpanrancang_terminal->sk_penetapan_lokasi = $path_sk_penetapan_lokasi;
        $simpanrancang_terminal->ba_serah_terima = $path_ba_serah_terima;
        $simpanrancang_terminal->sertifikat = $path_sertifikat;
        $simpanrancang_terminal->feasibility_study = $path_feasibilitystudy;
        $simpanrancang_terminal->master_plan = $path_masterplan;
        $simpanrancang_terminal->save();
        return redirect('/rancangterminal')->with('notif', 'Data berhasil tersimpan');
    }
    ...
    public function ShowEditRancangTerminal($id)
    {
        ...
        return view('html.edit_rancang_terminal', compact(
            'dataterminal',
    ...
    public function ShowPengajuanTerminal()
    {
        ...
        // $datarancang_terminal = rancang_terminal::all();
         $datauserid = ControllerBackend::ShowLoginTopMenu();
        $datapengajuan_terminal = pengajuan_terminal::select('*')->leftjoin('terminal', 'terminal.id_terminal', 'pengajuan_terminal.nama_terminal')->orderby('id_pengajuan_terminal', 'DESC')->get();
        return view('html.pengajuanterminal', compact('datapengajuan_terminal', 'dataterminal','datauserid'));
    }
    ...
    public function ShowProsesPembangunan()
    {
        ...
        // $datarancang_terminal = rancang_terminal::all();
         $datauserid = ControllerBackend::ShowLoginTopMenu();
        $dataproses_pembangunan = proses_pembangunan::select('*')->leftjoin('terminal', 'terminal.id_terminal', 'proses_pembangunan.nama_terminal')->orderby('id_proses_pembangunan', 'DESC')->get();
        return view('html.prosespembangunan', compact('dataproses_pembangunan', 'dataterminal','datauserid'));
    }
    ...
    public function ShowRampCheck(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $data = rampcheck::all();
        return view('html.rampcheck',compact('data','datauserid'));
    }
    ...
    public function ShowBuildingManagement(){
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $dataaset = building_management::orderby('id','DESC')->get(); 
        $terminal = terminal::all();
        return view('html.building_management',compact('datauserid','terminal','dataaset'));
    }
    ...
    public function ShowSimpanDataAset(Request $request){
        ...
        $simpan->kode_terminal = $request->kode_terminal;
    ...
    {
        $dataterminal = terminal::where('id_terminal',$id)->first();
       // dd($dataterminal);
        $datauserid = ControllerBackend::ShowLoginTopMenu();
        $dataprofil_terminal = profil_terminal::select('*')
                                ->leftjoin('terminal', 'terminal.id_terminal', 'profil_terminal.id_terminal')
                                ->orderby('id_profil_terminal', 'DESC')
                                ->where('terminal.id_terminal',$id)
                                ->get();
        $datafasilitasutama = fasilitas_utama::where('id_terminal',$id)->orderby('id','DESC')->get();
        $datafasilitaspenunjang = fasilitas_penunjang::where('id_terminal',$id)->orderby('id','DESC')->get();

        return view('html.profil_terminal', compact('dataprofil_terminal', 'dataterminal', 'datauserid','dataterminal','datafasilitasutama','datafasilitaspenunjang'));
    ...
    public function ShowProfilTerminalPrint($id=null,$type=null)
    {
        ...
        $hitungjumlahsdmpns = sdm::select('*')->leftjoin('terminal','terminal.id_terminal','sdm.id_terminal')
                                            ->where('terminal.id_terminal',$id)
                                            ->where('sdm.tipe','ASN')
                                            ->count();
        $hitungjumlahsdmnonpns = sdm::select('*')->leftjoin('terminal','terminal.id_terminal','sdm.id_terminal')
                                            ->where('terminal.id_terminal',$id)
                                            ->where('sdm.tipe','PPNPN')
                                            ->count();
        $hitungjumlahsdmppns = sdm::select('*')->leftjoin('terminal','terminal.id_terminal','sdm.id_terminal')
                                            ->where('terminal.id_terminal',$id)
                                            ->where('sdm.tipe','PPNS')
                                            ->count();
        $hitungjumlahakap = perusahaan_otobus::select('*')->leftjoin('terminal','terminal.id_terminal','perusahaan_otobus.id_terminal')
                                            ->where('terminal.id_terminal',$id)
                                            ->where('perusahaan_otobus.tipe','AKAP')
                                            ->count();
        $hitungjumlahakadp = perusahaan_otobus::select('*')->leftjoin('terminal','terminal.id_terminal','perusahaan_otobus.id_terminal')
                                            ->where('terminal.id_terminal',$id)
    ...
    public function ShowSimpanProfilTerminal(Request $request)
    {
        ...
        $simpanprofil_terminal->id_terminal = $request->id;
    ...
    public function kompetensi_sdm($id){
        ...
        return view('html.kompetensi_sdm',compact('datauserid','idsdm','kom'));
    }
    ...
    public function fotokendaraantiba($noken,$jam,$hal){
        ...
        $data = log_response_gate::where('log_response_gate.nomor_kendaraan',$noken)
                                              ...
                                              ->get();
                                          //    dd($data);
        return view('html.fotokendaraantiba',compact('datauserid','data'));
    }
