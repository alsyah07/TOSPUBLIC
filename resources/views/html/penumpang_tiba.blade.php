            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Data Penumpang Tiba</h2>
...
<table id="example" class="table table-responsive table-striped" style="width:100%; overflow: auto; overflow: auto;white-space:nowrap;">
    ...
    <form class="form" method="post" action="/updatekendaraantiba"> 
        ...
        <input type="hidden" name="id" id="id">
         <input type="hidden" name="type" value="tiba">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #17abb0;">
                    <h4 class="modal-title" id="myModalLabel16" style="color: white">Form Penumpang Tiba</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-1">
                                            ...
                                            <select class="form-select"  name="id_terminal"  required="" disabled="" oninvalid="this.setCustomValidity('Silahkan pilih terminal')" oninput="setCustomValidity('')">
                                                <option value="{{ $dataterminalget->kode_terminal_asal }}">{{ $dataterminalget->nama_wilayah }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group mb-1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-1">
                                            <label class="control-label">Jumlah Penumpang Tiba</label>
                                            <input type="number" class="form-control" placeholder="Masukan jumlah penumpang tiba" name="jumlah_penumpang" id="jumlah_penumpang_tiba" required="">
                                        </div>   
                                         <div class="form-group mb-1">
                ...
                $.ajax({
                  ...
                  success:function(data){
                    console.log('dataje',data);
                      ...
                      $('#masa_berlaku_kendaraanup').val(data.data.masa_berlaku_kendaraan);
                      $('#jumlah_penumpang_tiba').val(data.data.jumlah_penumpang_tiba);
