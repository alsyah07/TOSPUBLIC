            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                           {{--  <h2 class="content-header-title float-start mb-0"><a class="btn btn-success" href="/datakenadraankeluar">Kendaraan Keluar</a></h2> --}}
                            <h2 class="content-header-title float-start mb-0">Data Penumpang Turun</h2>
                ...
                <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                  {{--   <button type="button" class="btn btn-primary registerusers" >+ Tambah Penumpang Turun</button> --}}
                </div>
                 @if(session('notif'))
...
<table id="example" class="table table-responsive table-striped" style="width:100%; overflow: auto; overflow: auto;white-space:nowrap;">
    ...
    <form class="form" method="post" action="/updatekendaraanturun"> 
        @csrf()
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="type" value="turun">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #17abb0;">
                    <h4 class="modal-title" id="myModalLabel16" style="color: white">Form Penumpang Turun</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-1">
                                            <label class="control-label">Jumlah Penumpang Turun</label>
                                            <input type="number" class="form-control" placeholder="Masukan jumlah penumpang naik" name="jumlah_penumpang" id="jumlah_penumpang_turun" required="">
                                        </div>   
                                         <div class="form-group mb-1">
                ...
                $.ajax({
                  ...
                  success:function(data){
                    console.log('dataje',data);
                      ...
                      $('#masa_berlaku_kendaraanup').val(data.data.masa_berlaku_kendaraan);
                      $('#jumlah_penumpang_turun').val(data.data.jumlah_penumpang_turun);
