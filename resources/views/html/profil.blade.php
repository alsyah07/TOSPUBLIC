                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card profile-header mb-2">
                                <!-- profile cover photo -->
                                <img class="card-img-top" src="/gambar/Picture3.jpg" alt="User Profile Image" />
                                <!--/ profile cover photo -->
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="profile-img-container d-flex align-items-center">
                                        <div class="profile-img">
                                            <img src="/gambar/avatar.png" class="rounded img-fluid" alt="Card image" />
                                        </div>
                                        <!-- profile title -->
                                        <div class="profile-title ms-3">
                                            <h2 class="text-white">Admin</h2>
                                            <p class="text-white">Terminal Guntur Melati</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="profile-header-nav">
                                    ...
                                    <div class="container-fluid">
                                        <p>
                                        In convallis habitasse lorem nunc dapibus bibendum. At risus quis enim et feugiat nunc. Cras montes lorem congue. Penatibus erat interdum elementum elit velit dis. Molestie nunc maecenas aliquet tortor. Mollis sodales bibendum vivamus pellentesque eget viverra. Placerat massa at aptent fames.
                                        </p>
                                        <p>
                                        Commodo aenean litora feugiat diam class primis. Urna vitae mollis aliquet. Leo etiam fermentum id parturient auctor. Integer bibendum aliquam ullamcorper purus velit.
                                        </p>
                                        <p>
                                        Lobortis pharetra laoreet dictumst rutrum. Enim habitant imperdiet sed montes libero conubia diam. Amet diam velit arcu maecenas. Felis sollicitudin ex pulvinar. Dui vestibulum elementum etiam ipsum nullam.
                                        </p>
                                    </div>
                                </div>
                            </div>
