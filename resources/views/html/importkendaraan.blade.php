                        ...
                        <div class="col-12">
                            ...
                            <div style="padding: 10px; font-size: 12px;">
                                ...
                                <div style="padding: 10px; font-size: 12px;">
                                    {{-- <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            <a href="/importkendaraan" class="nav-link active"  type="button" role="tab" aria-controls="nav-home" aria-selected="true">Kendaraan Tiba</a>
                                            <a href="#" class="nav-link"  type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Kendaraan Keluar</a>
                                        </div>
                                    </nav> --}}
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                  ...
                                  <form class="form" method="post" action="/simpanimportkendaraantiba" enctype="multipart/form-data">
                                      @csrf()
                                      {{-- <input type="hidden" name="id" value="{{ $dataterminal->id_terminal }}" id="id">                        --}}
                                       <br>
                                       <a href="/doc/data_kendaraan_tiba.xlsx" class="btn btn-info" type="button" role="tab"><i class="fa fa-download"></i> Template</a>
                                       <div class="row">
                                           <div class="col-md-10">
                                               <div class="col-md-5">
                                                      <br>
                                                <h5> Import Data Kendaraan Tiba </h5>
                                                        </div>
                                              <div class="col-md-5">
